...
class _PlanningPageState extends State<PlanningPage> {
  final SvgPicture svg = SvgPicture.asset('Assets/SVG/plan_guy.svg');
  ...
  String excerciseBenefits =
      'Write Down your Goals, Any Quotes, What are you feeling? Write Down Every Good memory you had. Thank Higher Power\n';

  String nameOfActivity = "Plan";
  String nameOfActivitySubtitle = "Planning for 10 mins";

  String activityName = "Planning";
  ...
  void setupActivity(BuildContext context) async {
    ...
    if (streaksString == "") {
      PageActivity().addActivity("@Planning", 1);
      streaks = 1;
      setState(() {});
    }
